...
@Component({
  selector: 'app-drawing-azure-image-form',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    TextInputComponent,
  ...
  templateUrl: './drawing-azure-image-form.component.html',
  styleUrl: './drawing-azure-image-form.component.scss',
})
export class DrawingAzureImageFormComponent extends LanguageComponent {
  private _path = '';
