...
@Component({
  selector: 'app-art-search-drawing-filter-form',
  standalone: true,
  imports: [
    RouterOutlet,
    NgFor,
  ...
  templateUrl: './drawing-filter-form.component.html',
  styleUrl: './drawing-filter-form.component.scss',
})
export class DrawingFilterFormComponent
