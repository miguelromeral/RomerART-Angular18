...
import { DrawingCommentComponent } from './drawing-comment.component';

describe('DrawingCommentComponent', () => {
  let component: DrawingCommentComponent;
  let fixture: ComponentFixture<DrawingCommentComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DrawingCommentComponent);
