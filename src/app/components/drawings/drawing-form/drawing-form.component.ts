...
import { SelectInputComponent } from '@app/components/common/inputs/select-input/select-input.component';
import { SwitchComponent } from '@app/components/common/inputs/switch/switch.component';
...
import { DrawingCommentsFormComponent } from '../drawing-comments-form/drawing-comments-form.component';
import { DateInputComponent } from '@app/components/common/inputs/date-input/date-input.component';
...
import { DrawingAzureImageFormComponent } from '../drawing-azure-image-form/drawing-azure-image-form.component';
...
@Component({
  ...
  imports: [
    ...
    SectionComponent,
    DrawingCommentsFormComponent,
    DateInputComponent,
    DrawingThumbnailComponent,
    DrawingAzureImageFormComponent,
  ],
