...
import { DrawingImageComponent } from '@app/components/drawings/details/image/image.component';
...
describe('DrawingImageComponent', () => {
  let component: DrawingImageComponent;
  let fixture: ComponentFixture<DrawingImageComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [DrawingImageComponent, TranslateModule.forRoot()],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawingImageComponent);
