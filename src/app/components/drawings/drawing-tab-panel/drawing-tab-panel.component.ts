...
@Component({
  selector: 'app-drawing-tab-panel',
  standalone: true,
  imports: [CommonModule, TranslateModule, CustomTranslatePipe],
  templateUrl: './drawing-tab-panel.component.html',
  styleUrl: './drawing-tab-panel.component.scss',
})
export class DrawingTabPanelComponent
