...
@Component({
  selector: 'app-drawing-edit-screen',
  standalone: true,
  imports: [
    NgIf,
  ...
  templateUrl: './drawing-edit-screen.component.html',
  styleUrl: './drawing-edit-screen.component.scss',
})
export class DrawingEditScreenComponent
