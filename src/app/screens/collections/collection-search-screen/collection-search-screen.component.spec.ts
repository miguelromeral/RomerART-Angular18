...
import { CollectionSearchScreenComponent } from './collection-search-screen.component';
...
describe('CollectionSearchScreenComponent', () => {
  let component: CollectionSearchScreenComponent;
  let fixture: ComponentFixture<CollectionSearchScreenComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [CollectionSearchScreenComponent, TranslateModule.forRoot()],
      providers: [
    ...
    fixture = TestBed.createComponent(CollectionSearchScreenComponent);
