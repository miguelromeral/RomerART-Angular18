...
@Component({
  selector: 'app-collection-edit-screen',
  standalone: true,
  imports: [LayoutComponent, CommonModule, CollectionFormComponent],
  templateUrl: './collection-edit-screen.component.html',
  styleUrl: './collection-edit-screen.component.scss',
})
export class CollectionEditScreenComponent
